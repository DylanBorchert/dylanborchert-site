        ...
        <div id="about" className="w-full">
            <div className="w-full">
                <AutoTextSize
                    as="span"
                    maxFontSizePx={1000}
                    className={`font-bold antialiased text-transparent bg-clip-text font-center bg-gradient-to-r from-[${colorPalette?.LightVibrant}] via-[${colorPalette?.Vibrant}] to-[${colorPalette?.DarkVibrant}] bg-cover bg-center bg-fixed`}
                >
                    About Me.
                </AutoTextSize>
            </div>
