...
export default function HeroHeader() {
  ...
  return (
    <div className="flex justify-between p-3 items-center my-3">
      <div>
        <p className="flex-nowrap pr-3 font-semibold sm:text-base">
          DYLANBORCHERT
        </p>
      </div>
      <div className="text-xs flex md:flex-row flex-col items-center">
        <span className="text-xs">CALGARY, ALBERTA</span>
        <div className="flex items-center">
          <span className="px-1 pb-[3px]">—</span>
          <span className="font-mono w-16 animate-[pulse_5s_ease-in-out_infinite] font-medium text-sm">
            {shufflingTime}
          </span>
        </div>
      </div>
      <div className="*:mx-1 flex-wrap w-fit flex-col md:flex-row">
        <span
