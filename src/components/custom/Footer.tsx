...
export default function Footer(props: any) {
  ...
  return (
    <div className="w-full p-3 flex justify-center relative h-40 mx-auto max-w-[calc(100dvh*(5/4))] dark:text-palette-lightMuted text-palette-darkMuted border-t dark:border-palette-lightMuted border-palette-darkMuted">
      <div className="w-full flex flex-col justify-between h-full">
          ...
          <div className="flex gap-3 items-center">
            ...
            >
              <svg
                ...
                className="h-5 w-5 dark:fill-palette-lightMuted fill-palette-darkMuted"
              >
        ...
        <div className="flex justify-between items-center">
          ...
          >
            Get in touch
            <ArrowRight className="h-4 w-4 ml-1 group-hover:translate-x-1 group-hover:scale-125 transition duration-100 ease-in" />
          </div>
        </div>
      </div>
    </div>
