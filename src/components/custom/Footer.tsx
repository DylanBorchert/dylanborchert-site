            ...
            <div className="w-full flex flex-col justify-between h-full">
                ...
                <div className="flex justify-between">
                    <div className="flex gap-3 items-center">
                        <a href="https://www.linkedin.com/in/dylan-borchert" target="_blank" rel="noreferrer">
                            <svg
                                role="img"
                                viewBox="0 0 24 24"
                        ...
                        <a href="https://github.com/DylanBorchert" target="_blank" rel="noreferrer">
                            <svg
                                role="img"
                                viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="rounded-full flex items-center group cursor-pointer" onClick={openSheet}>
                        Get in touch
